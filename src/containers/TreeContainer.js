...
import { TreeInstance } from '../lib/systemManager/index';
...
class TreeContainer extends Component {
  ...
  render() {
    ...
    console.log('rendering TreeInstance, treeData = ', this.props.treeData);
    return(
      <TreeInstance zoom pan treeData={this.props.treeData} />
    );
